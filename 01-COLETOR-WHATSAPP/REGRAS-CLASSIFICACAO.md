...
## Resolução de conflito entre legenda, Azure e conteúdo fiscal

O rótulo semântico do Azure continua sendo um apoio importante, especialmente quando a foto chega
sem legenda. Ele não deve, porém, sobrepor uma evidência fiscal mais específica. A ordem segura
adotada pelo programa é:

1. produto de combustível acompanhado de litragem ou contexto de posto prevalece sobre o rótulo
   genérico de refeição;
2. na ausência de evidência forte, o tipo estruturado do Azure continua como fallback;
3. se a legenda e o documento apontarem tipos incompatíveis, o comprovante vai para revisão;
4. evidências concorrentes nunca são resolvidas por palpite.

Essa regra corrige o caso real em que um comprovante com gasolina/litros foi marcado como `Meal`
sem perder a leitura de alimentação em cupons sem legenda.
